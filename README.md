...
Crear tablas en Hive y generar el resumen:
...
Ejecutar el script de transferencia a MySQL:

python transfer_to_mysql.py

Configurar la fuente de datos en Grafana y visualizar los resultados.
...
Se pueden realizar mejoras opcionales para aumentar la calificación:

Visualización en Superset (+0.5 puntos)

Uso de Impala en lugar de Hive (+1 punto)

Implementación en Kubernetes (+1 punto)

Despliegue en la nube (+1 punto)
...
Límite de entrega: 9 de abril / 23:59
